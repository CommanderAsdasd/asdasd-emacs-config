...
methods the save hook cannot detect, like file synchronization."
          ...
          (org-store-new-agenda-file-list
           (append (list "c:/Users/AleksandrTankovskii(/git/News_scraping_assignment/") (directory-files-recursively
            org-directory (rx ".org" eos)
            nil
  ...
  :config
  ;; (my/org-agenda-files-track-init)
