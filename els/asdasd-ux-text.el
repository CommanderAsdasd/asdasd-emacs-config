...
(defun asdasd-ux-text-process-buffer-fields (keep-first? predicate)
...
(use-package emacs
  ...
  (:map isearch-(message "message" format-args)ode-map ("C-S-w" . kill-isearch-match)
        ("M-S-w" . copy-isearch-match))
  :config
  (default-input-method "russian-computer")
  (custom-require-spaces nil)
  ...
  :custom (default-input-method 'russian-computer))
